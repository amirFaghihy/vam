    ...
    public class CharityLoanInstallmentsController : GenericController
    {
            ...
            bool isDesc = true)
        {
            try
            {
                ...
                ViewBag.paymentDateFrom = paymentDateFrom;
                ViewBag.paymentDateTo = paymentDateTo;
                ...
                DateTime? _paymentDateFrom = null;
                DateTime? _paymentDateTo = null;
                ...
                {
                    _paymentDateFrom = await paymentDateFrom.ToConvertPersianDateToDateTimeAsync(DateTimeFormat.yyyy_mm_dd, DateTimeSpiliter.slash);
                }
                if (!string.IsNullOrEmpty(paymentDateTo))
                {
                    _paymentDateTo = await paymentDateTo.ToConvertPersianDateToDateTimeAsync(DateTimeFormat.yyyy_mm_dd, DateTimeSpiliter.slash);
                }
                ...
                Tuple<IQueryable<CharityLoanInstallments>, ResultStatusOperation> result = charityLoanInstallmentsService.SpecificationGetData(charityLoanId, installmentAmount, _paymentDateFrom, _paymentDateTo, _registerDateFrom, _registerDateTo, isdone);
